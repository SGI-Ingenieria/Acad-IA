...
- **Inicio y catálogos:** cuatro destinos: Inicio, Planes, Asignaturas y Cuenta. Inicio muestra la actividad pendiente (notificaciones sin leer) o «Todo al día»; tocarla abre Actividad con navegación de regreso. No hay botones de refrescar. Se reconcilian tras escrituras, eventos Realtime, reconexión y al retomar la pantalla, conservando el contenido visible y las páginas ya cargadas.
...
- **Duración del ciclo:** las semanas aparecen en el resumen del plan y se editan desde ese dato; nombre/fecha curriculares conservan las restricciones del servidor.
...
- **Mapa curricular:** un selector nativo ofrece **Mapa / Lista / Bloques**. Los bloques definidos van primero; «Sin bloque» y luego «Sin ciclo» quedan al final del mapa. La vista Bloques reúne consulta, alta y edición. En lista, mantén pulsada una asignatura y elige **Mover asignatura**; los destinos conservan sus colores. TalkBack ofrece la misma acción contextual. El **+** superior crea una asignatura.

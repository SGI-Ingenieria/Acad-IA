...
const CheckboxCardDemo = () => {
  return (
    <div className="space-y-relacionado">
      <Label className="border-border hover:border-primary/30 hover:bg-accent/50 gap-relacionado gap-control p-control flex cursor-pointer items-center items-start rounded-lg border transition-colors has-aria-checked:border-blue-600 has-aria-checked:bg-blue-50 dark:has-aria-checked:border-blue-900 dark:has-aria-checked:bg-blue-950">
        <Checkbox
          defaultChecked
        ...
        />
        <div className="gap-relacionado grid font-normal">
      ...
      <Label className="hover:bg-accent/50 gap-relacionado p-control flex items-start rounded-lg border has-aria-checked:border-blue-600 has-aria-checked:bg-blue-50 dark:has-aria-checked:border-blue-900 dark:has-aria-checked:bg-blue-950">

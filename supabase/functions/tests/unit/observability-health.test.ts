...
Deno.test("classifyEdgeProbeResult treats InvalidWorkerCreation as critical", () => {
...
Deno.test("classifyEdgeProbeResult accepts diagnostic 405 as loaded function", () => {
  const result = classifyEdgeProbeResult({
...
Deno.test("compareMigrations detects missing migrations from GitHub main", () => {
